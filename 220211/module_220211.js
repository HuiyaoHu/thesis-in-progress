...
var concrete = new THREE.MeshStandardMaterial({color: 0xc4c4c4, side: THREE.DoubleSide}) ;
...
function creatingScene() {
    ...
    camera = new THREE.PerspectiveCamera( 45, container.clientWidth / container.clientHeight, 1, 10000  ); //FOV, aspect ratio, near, far of clipping plane
